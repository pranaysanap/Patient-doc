...
Additional Info: ${additionalInfo || "None provided"}
    ...
    try {
      ...
      if (status.fallbackMode || !status.initialized) {
        ...
        vaidya.sendMessage(`I'm currently experiencing technical difficulties and can only provide general guidance. For your symptoms (${selectedSymptoms.join(", ")}), I recommend:
...
Please note: This is general advice only. For specific medical concerns, always consult with a qualified healthcare professional.`);
      ...
      await vaidya.sendMessage(symptomSummary);
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3">
              {bodyParts.map((part) => (
                ...
                >
                  <Card
                    className={`cursor-pointer transition-all overflow-hidden border-0 shadow-md ${selectedBodyPart === part.id
                  ...
                  >
                    ...
                    <CardContent className="p-3 flex items-center gap-3">
                      <div className={`h-10 w-10 rounded-full bg-gradient-to-br ${selectedBodyPart === part.id ? part.gradient : 'from-primary/20 to-primary/10'
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {selectedBodyPart && symptomsByBodyPart[selectedBodyPart].map((symptom) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`flex items-center space-x-3 p-4 rounded-lg cursor-pointer transition-all ${isSelected
            ...
            <RadioGroup value={symptomDuration || ""} onValueChange={setSymptomDuration} className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                return (
                  ...
                  >
                    <div
                      className={`flex items-center space-x-4 p-4 rounded-lg cursor-pointer transition-all ${isSelected
                        ? `border-0 bg-gradient-to-r ${gradientClass} shadow-md backdrop-blur-sm`
                        : 'border border-input/30 hover:bg-white/30 dark:hover:bg-slate-800/30 bg-white/20 dark:bg-slate-900/20 backdrop-blur-sm'
                        }`}
            ...
            <RadioGroup value={symptomSeverity || ""} onValueChange={setSymptomSeverity} className="space-y-4">
              {[
                ...
                return (
                  ...
                  >
                    <div
                      className={`relative overflow-hidden rounded-lg cursor-pointer transition-all ${isSelected
