...
export function FAQSection() {
  ...
  const faqs = [
    ...
    {
      question: "Can VaidyaSetu replace a visit to my doctor?",
      answer: "No, VaidyaSetu is designed to be a supplementary tool that helps you monitor your health and facilitates conversations with healthcare providers. It is not intended to replace professional medical diagnosis or treatment. Always consult with qualified healthcare professionals for medical advice, diagnosis, or treatment recommendations."
    },
    {
      question: "What smartphones are compatible with VaidyaSetu?",
      answer: "VaidyaSetu is compatible with most modern smartphones running iOS 14+ or Android 9+. The quality of your device's microphone can impact recording quality, but our AI is designed to work with standard smartphone hardware. For optimal results, we recommend using devices manufactured after 2018."
    },
    {
    ...
    {
      question: "Can I share my VaidyaSetu results with my doctor?",
      answer: "Yes, VaidyaSetu makes it easy to share your results with healthcare providers. You can generate detailed PDF reports that include waveforms, AI analysis results, and historical trends. These can be shared via email, messaging apps, or through our secure healthcare provider portal if your doctor is registered with our system."
    },
    {
      question: "What conditions can VaidyaSetu detect?",
      answer: "VaidyaSetu can detect a range of heart and lung conditions, including but not limited to: heart murmurs, arrhythmias, valve abnormalities, wheezes, crackles, rhonchi, and abnormal breathing patterns. The system provides confidence scores for each detection and can identify patterns that may warrant further medical investigation."
    },
    {
      question: "How does VaidyaSetu compare to traditional stethoscopes?",
      answer: "VaidyaSetu offers several advantages over traditional stethoscopes: it provides objective AI analysis rather than relying solely on the listener's expertise, it creates permanent recordings that can be reviewed and shared, it tracks changes over time, and it's accessible to non-medical users. However, in clinical settings, it's designed to complement rather than replace traditional tools used by healthcare professionals."
    }
  ];
    ...
    <section>
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground max-w-3xl mx-auto">
          Find answers to common questions about VaidyaSetu's technology and usage
        </p>
      </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="text-center md:text-left md:flex-1">
                ...
                <p className="text-muted-foreground mb-4">
                  Our support team is ready to help with any questions you may have about VaidyaSetu.
                </p>
